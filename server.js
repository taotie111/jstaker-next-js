...
// 定义定时任务
const job = schedule.scheduleJob('* * * * * *', async () => { // 每天晚上12点触发任务
    ...
    // console.log(startDate,currentDate, currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(),"startDate");
    // 获取所有在指定时间范围内的数据
